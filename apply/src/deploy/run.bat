...
set class_path=%RUNHOME%;%RUNHOME%policy-lcm.jar
echo ### jvm_opts: %jvm_opts%
echo ### class_path: %class_path%

%JAVA% -classpath %class_path% %jvm_opts% org.openo.policy.lcm.App server %RUNHOME%/conf/config.yaml
